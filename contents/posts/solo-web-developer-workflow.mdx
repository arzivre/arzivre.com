---
slug: 'solo-web-developer-workflow'
title: 'Solo-Web Developer Workflow'
date: '2021-11-15T03:04:05.678Z'
excerpt: 'Summarize my suggestions developing website'
image: ''
---

# Solo Web Developer Workflow

Developing website can be done in many way, some suggestions to develop web
...
1.Infrastructure as in what are the pieces you're using in your backend :

(db, api framework, servers, web server - though web server can come when you're actually releasing this project) UI framework (+ any associated tooling to help compile)

1.Architecture as in how all your infra components will talk together:
...
- Start building out your backend Even if it's just the simplest endpoint to begin with, as long as you're returning actual data that would be needed by your frontend
