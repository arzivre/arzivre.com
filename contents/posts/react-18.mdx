...
excerpt: 'React 18 sudah rilis dan banyak hal yang terjadi supaya cuncurrent fitur dapat terjadi'
image: ''
---
...
![tes](/images/post/react17-synchronous-rendering.png)
...
![tes](/images/post/react18-concurrent.png)

Di React 18 render terjadi secara Concunrrent. React dapat melihat jika ada update dan mulai menyiapkan update itu di render phase , menghitung jsx tree baru, diff, dan kemudian hal lain terjadi dan menentukan untuk malakukan update ke dom, jadi render dapat digangu.
